...
(function() {
 var loadPackage = function(metadata) {
    ...
    var PACKAGE_NAME = 'Procrastination Game.data';
    var REMOTE_PACKAGE_BASE = 'Procrastination Game.data';
...
Module['FS_createPath']('/Managed/mono', '2.0', true, true);
    ...
    function processPackageData(arrayBuffer) {
      ...
      DataRequest.prototype.byteArray = byteArray;
          ...
          Module['removeRunDependency']('datafile_Procrastination Game.data');

    };
    Module['addRunDependency']('datafile_Procrastination Game.data');
